...
public class ContactOperations {
	...
	public static final String MIME_PROFILE = "vnd.android.cursor.item/vnd.perssearch.profile";
 ...
 int userId, /*
	...
	public ContactOperations(Context context, int userId, Account account, BatchOperation batchOperation) {
	 ...
	 * @return instance of ContactOperations
	 */
    public ContactOperations addEmail(String email, int typeWork) {
        mValues.clear();
        if (!TextUtils.isEmpty(email)) {
            mValues.put(Email.DATA, email);
			mValues.put(Email.TYPE, typeWork);
    ...
    public ContactOperations addProfileAction(long userId) {
        mValues.clear();
        if (userId != 0) {
			mValues.put(DATA_PID, userId);
			mValues.put(DATA_SUMMARY, "perssearch summary");
			mValues.put(DATA_DETAIL, "perssearch detail");
			mValues.put(Data.MIMETYPE, MIME_PROFILE);
            addInsertOp();
        }
        return this;
    }
